...
class GenericMasterModel(BaseModel):
...
class Realestateagents(GenericMasterModel):
    prefix = models.CharField(
        max_length=5, verbose_name=("Prefix"), blank=True, null=True
    )
    email = models.EmailField(verbose_name=_("Email"))
    website = models.TextField(blank=True, null=True, verbose_name=("Website"))
    phonenumber = models.CharField(
        max_length=30, verbose_name=("Phone Number"), null=True, blank=True
    )
...
class Realestatepropertyowner(GenericMasterModel):
    surname = models.CharField(
        max_length=100, verbose_name=("Surname"), blank=True, null=True
    )
    email = models.EmailField(verbose_name=("Email"))
    phonenumber = models.CharField(
        max_length=30, verbose_name=("Phone Number"), null=True, blank=True
    )
    owner_representative = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=("Owner Representative")
    )
    isnotificationnewtickets = models.BooleanField(
        null=True, blank=True, verbose_name=("Is Notification New Tickets")
    )
    isnotificationnewupdates = models.BooleanField(
        null=True, blank=True, verbose_name=("Is Notification New Updates")
    )
    isnotificationticketdeadline = models.BooleanField(
        null=True, blank=True, verbose_name=("Is Notification Ticket Deadline")
    )
    isactive = models.BooleanField(null=True, blank=True, verbose_name=("Is Active"))
    lastlogindate = models.DateTimeField(
        null=True, blank=True, verbose_name=("Last Logindate")
    )
    attachment = models.FileField(
        upload_to="attachement/", blank=True, null=True, verbose_name=("Attachment")
    )
...
class Realestatepropertytenant(GenericMasterModel):
    STATUS_CHOICES = [
        ("ENQUIRER", "Enquiry"),
        ("REGISTER", "Registered"),
        ("OCCUPIED", "Occupied"),
    ...
    userid = models.CharField(
        max_length=36, blank=True, null=True, verbose_name=("User Id")
    )
    realestatepersontypeid = models.IntegerField(
        null=True, blank=True, verbose_name=("Person Type Id")
    )
    surname = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=("Surname")
    )
    email = models.EmailField(verbose_name=_("Email"))
    phonenumber = models.CharField(
        max_length=30, verbose_name=("Phone Number"), null=True, blank=True
...
class Messages(BaseModel):
    ...
    isemailnotification = models.BooleanField(null=True, blank=True)
    isimportant = models.BooleanField(null=True, blank=True)
    isallowcomment = models.BooleanField(null=True, blank=True)
    issendimmediately = models.BooleanField(null=True, blank=True)
    senddate = models.DateTimeField(blank=True, null=True)
    created = models.DateTimeField(blank=True, null=True)
    createdrealestateownerid = models.ForeignKey(
        "Realestatepropertyowner", on_delete=models.PROTECT
    )
...
class Messagecomments(BaseModel):
    messageid = models.ForeignKey(
        "Messages", on_delete=models.PROTECT, null=True, blank=True
    )
    realestateownerid = models.ForeignKey(
        "Realestatepropertyowner", on_delete=models.PROTECT
    )
...
class Messagerecipients(BaseModel):
    ...
    realestateownerid = models.OneToOneField(
        "Realestatepropertyowner", on_delete=models.PROTECT, primary_key=True
    )
...
class Realestateproperties(GenericMasterModel):
    realestateagentid = models.ForeignKey(
        Realestateagents,
    ...
    realted_property = models.ForeignKey(
        "Realestateproperties",
        null=True,
        blank=True,
        on_delete=models.PROTECT,
        related_name="sub_group",
        verbose_name=("Realted Property"),
    )
    isactive = models.BooleanField(null=True, blank=True, verbose_name=("Is Active"))
    attachment = models.FileField(
        upload_to="attachement/", blank=True, null=True, verbose_name=("Attachment")
...
class Localestringresources(BaseModel):
    ...
    languageid = models.ForeignKey(
        Languages, on_delete=models.PROTECT, db_column="LanguageId"
    )
...
class Localizedproperties(BaseModel):
    ...
    entityname = models.CharField(
        db_column="EntityName",
        max_length=100,
    )
    propertyname = models.CharField(
        db_column="PropertyName",
        max_length=100,
    )
    localevalue = models.TextField(
        db_column="LocaleValue",
    )
...
class Realestatepropertiessubgroup(BaseModel):
    property = models.ForeignKey(
        Realestateproperties, on_delete=models.PROTECT, verbose_name=("Property")
    )
    name = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=("Name")
    )
    Description = models.TextField(null=True, blank=True, verbose_name=("Description"))
    area = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=("Area")
    )
    amenities = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=("Amenities")
    )
...
class Realestateobjects(BaseModel):
    ...
    realestatepropertyid = models.ForeignKey(
        Realestateproperties,
        related_name="objects_detail",
        on_delete=models.PROTECT,
        null=True,
        blank=True,
        verbose_name=("Property Id"),
    )
    objectusagetypeid = models.CharField(
        max_length=10,
        choices=USAGE_CHOICE,
        null=True,
        blank=True,
        verbose_name=("Usage Type id"),
    )
    object_name = models.CharField(max_length=50, verbose_name=("Object Name"))
    object_description = models.CharField(
        max_length=100, verbose_name="Object Description", blank=True, null=True
    )
    location = models.CharField(
        max_length=100, verbose_name="Location", blank=True, null=True
    )
    floor = models.CharField(
        max_length=20, blank=True, null=True, verbose_name=("Floor")
    )
    rooms = models.CharField(
        max_length=20, blank=True, null=True, verbose_name=("Rooms")
    )
    value = models.FloatField(
        default=0.0, null=True, blank=True, verbose_name=("Value")
    )
    surfacearea = models.IntegerField(
        blank=True, null=True, verbose_name=("Surface Area")
    )
    isactive = models.BooleanField(null=True, blank=True, verbose_name=("Is Active"))
    attachments = models.FileField(
        upload_to="attachement/", blank=True, null=True, verbose_name=("Attachments")
    )
    status = models.CharField(
        max_length=10,
        choices=STATUS_CHOICES,
...
class Realestateobjectsdetail(BaseModel):
    ...
    object_code = models.CharField(
        max_length=15, null=True, blank=True, verbose_name=("Object Code")
    )
    ...
    category = models.CharField(
        max_length=50, null=True, blank=True, verbose_name=("Category")
    )
    ...
    object_name = models.CharField(
        max_length=100, verbose_name=("Object Name"), blank=True, null=True
    )
    object_description = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Object Description"
    )
    related_detail = models.ForeignKey(
        "Realestateobjectsdetail",
        on_delete=models.PROTECT,
        null=True,
        blank=True,
        verbose_name=("Related Detail"),
    ...
    normal_wear = models.BooleanField(
        blank=True, null=True, verbose_name=("Normal Wear")
    )
    notes = models.TextField(blank=True, null=True, verbose_name=("Notes"))
    image = models.ImageField(
        upload_to="object_images_master/", null=True, blank=True, verbose_name=("Image")
    )
    count = models.IntegerField(
        default=0, verbose_name=("Count"), null=True, blank=True
    )
...
class Realestatekeyhandover(BaseModel):
    ...
    deterioration = MultiSelectField(
        choices=DETERIORATION_CHOICES,
        max_length=30,
        null=True,
        blank=True,
        verbose_name="Deterioration",
    )
    ...
    photo = models.ImageField(
        upload_to="master_key_photos/", null=True, blank=True, verbose_name=("Photo")
    )
    count = models.IntegerField(
        default=0, verbose_name=("Count"), null=True, blank=True
    )
    description = models.TextField(null=True, blank=True, verbose_name=("Description"))
    name = models.CharField(
        max_length=300, null=True, blank=True, verbose_name=("Name")
    )
...
class Realestatemeterhandover(BaseModel):
    ...
    meterno = models.CharField(
        max_length=200, null=True, blank=True, verbose_name=("Meter Number")
    )
    reading = models.CharField(
        max_length=200, null=True, blank=True, verbose_name=("Reading")
    )
    photos = models.ImageField(
        upload_to="master_meter_photos/", null=True, blank=True, verbose_name=("Photo")
    )
    count = models.IntegerField(
        default=0, verbose_name=("Count"), null=True, blank=True
    )
    ...
    whochange = models.CharField(
        max_length=200,
        choices=WHO_CHANGES,
        null=True,
        blank=True,
        verbose_name=("Who Change"),
    )
    ...
    accessories = MultiSelectField(
        choices=ACCESSORIES_CHOICES,
        max_length=30,
        null=True,
        blank=True,
...
class FurnitureInspectionMaster(BaseModel):
    ...
    cleaning_type = models.CharField(
        max_length=50, choices=CLEANING_TYPES, verbose_name=("Cleaning Type")
    )
    photos = models.ImageField(
        upload_to="master_inspection_photos/",
        null=True,
        blank=True,
        verbose_name=("Photos"),
    )
...
class Realestatepropertymanagement(BaseModel):
    realestatepropertyid = models.ForeignKey(
        Realestateproperties, on_delete=models.PROTECT, verbose_name=_("Property")
    )
    realestateownerid = models.ForeignKey(
    ...
    realestateagentid = models.ForeignKey(
        ...
        null=True,
        blank=True,
        verbose_name=_("Property Agent"),
    )
    realestateobjectid = models.ForeignKey(
        Realestateobjects,
        on_delete=models.PROTECT,
        null=True,
        blank=True,
    ...
    manageby_id = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=_("Manager Id")
    )
    manager_name = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=_("Manager Name")
    )
    manager_email = models.EmailField(
        null=True, blank=True, verbose_name=_("Manager Email")
    )
    manager_Phone = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=_("Manager Phone")
    )
...
class Realestateserviceproviders(GenericMasterModel):
    jobs = (
        ("manager", ("Manager")),
        ("others", ("Others")),
    )
    ...
    realestatepropertyid = models.ForeignKey(
        ...
        null=True,
        blank=True,
        verbose_name=("Realestate Property"),
    )
    field = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=("Field")
    )
    languageid = models.IntegerField(
        null=True, blank=True, verbose_name=("Language Id")
    )
    ...
    job = models.CharField(
        max_length=20, choices=jobs, default="others", verbose_name=("Job")
    )
...
class Agenda(BaseModel):
    ...
    status = models.CharField(
        max_length=20, choices=status, default="draft", verbose_name=("Status")
    )
...
class AgendaDetails(BaseModel):
    agenda = models.ForeignKey(
        Agenda,
        related_name="agenda_detail",
        on_delete=models.PROTECT,
        verbose_name=("Agenda"),
    )
    topic_details = models.CharField(
        max_length=100, blank=True, null=True, verbose_name=("Topic Details")
    )
...
class Quorums(BaseModel):
    ...
    present_votes = models.IntegerField(verbose_name=("Present Votes"))
    condition = models.CharField(
        max_length=30, choices=condition, verbose_name=("Condition")
    )
...
class Votes(BaseModel):
    ...
    majority = models.IntegerField(verbose_name=("Majority"), blank=True, null=True)
    condition = models.CharField(
        max_length=30,
        choices=condition,
    ...
    basic_set = models.CharField(
        max_length=50, choices=sets, verbose_name=("Basic Set"), blank=True, null=True
    )
    tie_case = models.CharField(
        max_length=50, choices=cases, verbose_name=("Tie Case"), blank=True, null=True
    )
...
class Mettingtemplate(BaseModel):
    ...
    agenda = models.ForeignKey(
        Agenda, related_name="agenda", on_delete=models.PROTECT, verbose_name=("Agenda")
    )
    voting_circle = models.ForeignKey(
        Realestatepropertymanagement,
        related_name="voting_circle",
        on_delete=models.PROTECT,
        verbose_name=("Voting Circle"),
    )
...
class Appendicesmaster(BaseModel):
    ...
    photos = models.ImageField(
        upload_to="master_key_photos/", null=True, blank=True, verbose_name=("Photos")
    )
    count = models.IntegerField(
        default=0, verbose_name=("Count"), null=True, blank=True
    )
    ...
    others = models.CharField(max_length=50, null=True, blank=True)
    is_done = models.BooleanField(verbose_name=("Is Done"), null=True, blank=True)
    is_todo = models.BooleanField(verbose_name=("Is Todo"), null=True, blank=True)
