...
class MeetingSchedule(BaseModel):
    ...
    submission_deadline =models.CharField(max_length=50,blank=True, null=True)
    dispatch_invitation=models.CharField(max_length=50,blank=True, null=True)
    online_voting = models.CharField(max_length=50,blank=True, null=True)
...
class MeetingSubAgendaDetails(BaseModel):
    meeting_agenda = models.ForeignKey(MeetingAgenda,blank=True,null=True,related_name="meetingagenda_detail",on_delete=models.CASCADE,verbose_name=("Meeting Agenda"))
