...
from masters.models import (
    ...
    Realestatemeterhandover,
    Realestatepropertyowner,
    Appendicesmaster,
    FurnitureInspectionMaster,
...
class CheckInOut(BaseModel):
    ...
    checkin_id = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="checkin_ids",
        on_delete=models.PROTECT,
    )
    service_ticket_number = models.UUIDField(
        default=uuid.uuid4, editable=False, unique=True
    )
    object_check_in = models.ForeignKey(
        Realestateobjects, on_delete=models.PROTECT, null=True, blank=True
    )
    ...
    object_detail_list = models.ForeignKey(
        "ObjectListInspection", on_delete=models.PROTECT, null=True, blank=True
    )
...
class GeneralInspection(BaseModel):
    ...
    service_id = models.ForeignKey(
        CheckInOut, on_delete=models.PROTECT, null=True, blank=True
    )
...
class ObjectListInspection(BaseModel):
    ...
    object_detail_list = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="object_inspections",
    )
    ...
    object_name = models.CharField(
        max_length=50, null=True, blank=True, verbose_name=("Object Name")
    )
    ...
    inorder = models.BooleanField(
        blank=True, null=True, verbose_name=("In Order"), default=False
    )
    normal_wear = models.BooleanField(
        blank=True, null=True, verbose_name=("Normal Wear"), default=False
    )
    ...
    color = models.CharField(
        max_length=100, null=True, blank=True, verbose_name=("Color")
    )
...
class Realestatekey(BaseModel):
    ...
    checkin = models.ForeignKey(
        CheckInOut, on_delete=models.CASCADE, null=True, blank=True
    )
    obj = models.ForeignKey(
        Realestatekeyhandover, on_delete=models.CASCADE, null=True, blank=True
    )
...
class Realestatemeter(BaseModel):
    ...
    obj = models.ForeignKey(
        Realestatemeterhandover, on_delete=models.PROTECT, null=True, blank=True
    )
    ...
    count = models.IntegerField(
        default=0, null=True, blank=True, verbose_name=("Count")
    )
...
class Appendicestransaction(BaseModel):
    ...
    obj = models.ForeignKey(
        Appendicesmaster, on_delete=models.PROTECT, null=True, blank=True
    )
    ...
    is_done = models.BooleanField(
        default=False, verbose_name=("Is Done"), null=True, blank=True
    )
    is_todo = models.BooleanField(
        default=False, verbose_name=("Is Todo"), null=True, blank=True
    )
...
class CheckinContacts(BaseModel):
    ...
    managedby_email = models.EmailField(blank=True, null=True)
    ...
    serviceprovider_tel = models.CharField(
        max_length=100,
        null=True,
        blank=True,
    )
